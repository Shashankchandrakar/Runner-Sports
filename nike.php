...
<?php /*$data=mysqli_query($con,"select * from product_detail_table where product_company='Nike'");
	...
	<table border=2>	
		<?php 
                    ...
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Nike' order by product_selling desc ");
                } elseif (@strcmp($_GET['sort'] , 'LowtoHigh')==0) {
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Nike' order by product_selling asc ");
                } elseif (@strcmp($_GET['sort'], 'Name')==0) {
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Nike' order by product_name ");
                } else {
                    $data = \mysqli_query($con, "select * from product_detail_table where product_company='Nike'");
                }
                $count=0;
		$flag=false;
