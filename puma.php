	...
	<table border=2>	
		<?php 
		 if (@strcmp($_GET['sort'] ,'HightoLow')==0) {
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Puma' order by product_selling desc ");
                } elseif (@strcmp($_GET['sort'] , 'LowtoHigh')==0) {
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Puma' order by product_selling asc ");
                } elseif (@strcmp($_GET['sort'], 'Name')==0) {
                    $data = mysqli_query($con, "select * from product_detail_table where product_company='Puma' order by product_name ");
                } else {
                    $data = \mysqli_query($con, "select * from product_detail_table where product_company='Puma'");
                }
		$count=0;
		$flag=false;
