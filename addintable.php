...
<div class="header_top">
	...
	<?php 
		...
		{
			$_SESSION['key']=$_SESSION['key']."<li>".$_POST['key']."</li>";
			
		}

		?>
	<div style='Padding: 1em 0em 0em 2em;'>
		<h3>Insert Key Features of Shoes</h3>
		<table  >
		<form method="POST">
		
		<tr><th>Product Code  </th><td><input type="text" name="code"  required value=<?php echo$_GET['code'];?> /></td></tr>
		
		<tr><th>Product Feature  </th><td><textarea cols=26 rows=3 name="key" required autofocus ></textarea> </td></tr>
		<tr><th><input type="submit" name="submit" value="Add Next Point"/></th></tr>
		
		</form>
	</div>
	<tr><th><a href="addkeyindb.php?code=<?php echo$_GET['code'];?>"><button >Finish</button></a></th></tr>
	</table>
	</body>
</html>