...
<div class="header_top">
	...
	<div class="head-bann">
		<div class="container">
			...
			<li><a class="color4" href="delete.php">Delete Product</a>
				...
				<li><a class="color3" href="allorders.php">All Orders</a>
	...
	<div style="Padding:.9em 0em 0em 2em;">
	<?php 
		require("connect.php");
		$data=mysqli_query($con,"select * from my_cart");
		echo "<table border=3 >";
		echo "<tr><th style='Padding:.8em';>Cutomer Email ID</th><th style='Padding:.8em'>Product Code</th><th style='Padding:.8em'style='Padding:.8em'>Quantity</th></tr>";
		while($val=mysqli_fetch_array($data))
		{
			echo "<tr ><td >$val[0]</td><td style='Padding:.8em'>$val[1]</td><td style='Padding:.8em'>$val[2]</td></tr>";
		}
		?>
	</div>