...
<?php
	require("connect.php");
	 if(isset($_POST['submit']))
	 {
		...
		$data=mysqli_query($con,"update product_detail_table set product_code=$code,product_name='$name',product_category='$category',product_details='$details',product_price=$buying,product_selling=$selling,product_actual=$mrp where product_code=$code");
		
		if($data)
		{
		
			echo "<script>alert('Product Has Been Updated');window.location = 'admin.php'</script>";
		}
	...
	<div style="Padding:2em 0em 0em 3em ;">
		...
		<tr><th>Product Code : </th><th><input type="text" name="code" id="code" value='.@$_GET[code].' required  /></th></tr>
		...
		<tr><th><input type="submit" name="submit"  value="Edit Product" style="background:#00405d;Color:white;" id="register-submit" /></th></th></th></tr>
		</table>
		</form>
	</div>
	';}?>